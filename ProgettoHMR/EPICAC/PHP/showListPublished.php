...
<body>
	...
	<div class="HMR_Content">
		...
		<div id="listaEventi">
				...
				<h1>Avvenimenti Pubblicati</h1> </br>
				...
				<?php
					...
					$query = "SELECT h.IdHa, h.Date, h.Title, h.Subtitle, h.Anchor, h.State, GROUP_CONCAT(DISTINCT(p1.Brief)) as autori FROM happenings as h LEFT JOIN happeningpeople as hp ON h.IdHa = hp.IdHa left join people as p1 ON p1.IdPp = hp.IdPp WHERE State= 'Pubblicato' GROUP By h.IdHa ORDER BY h.IdHa desc";
